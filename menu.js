...
(function () {
  ...
  var FOOTER_HTML = [
    ...
    '        <p>Founder Debra L Hartmann brings 30+ years of experience that began in traditional publishing and includes working as an Editor, Managing Editor, and Chief Publishing Officer. In the self-publishing space, her mission is to provide authors with direct access to high quality book production services unparalleled in today’s internet-based sea of misinformation and predatory practices.</p>',
